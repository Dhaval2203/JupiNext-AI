			...
			<section className="relative overflow-hidden bg-gradient-to-b from-background to-muted/30 px-6 py-24 sm:py-32 lg:px-8">
				<div className="mx-auto max-w-4xl text-center">
					<h1 className="text-balance text-5xl font-bold tracking-tight text-foreground sm:text-7xl">
						Where the <span className="text-primary">Next</span> <span className="text-secondary">Begins</span>
					</h1>
					...
					<div className="mt-16 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
						{services.map((service) => {
							...
							return (
								<Card
									key={service.title}
									className="group overflow-hidden rounded-xl border border-border bg-card p-8 transition-all hover:shadow-lg hover:-translate-y-1"
								>
									<div className={`mb-4 inline-flex rounded-lg bg-${service.color}/10 p-3`}>
										<Icon className={`h-6 w-6 text-${service.color}`} />
									</div>

									<h3 className={`text-xl font-semibold text-${service.color}`}>
										{service.title}
									</h3>
				...
				<div className="mx-auto max-w-7xl">
					...
					<div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
						<div className="flex flex-col items-center text-center">
							...
							<h3 className="mt-4 text-lg font-semibold text-primary">Innovation-First</h3>
						...
						<div className="flex flex-col items-center text-center">
							...
							<h3 className="mt-4 text-lg font-semibold text-primary">Scalable Solutions</h3>
							<p className="mt-2 text-sm text-muted-foreground">
						...
						<div className="flex flex-col items-center text-center">
							...
							<h3 className="mt-4 text-lg font-semibold text-primary">Secure Architecture</h3>
							<p className="mt-2 text-sm text-muted-foreground">
						...
						<div className="flex flex-col items-center text-center">
							...
							<h3 className="mt-4 text-lg font-semibold text-primary">Clear Communication</h3>
							<p className="mt-2 text-sm text-muted-foreground">
