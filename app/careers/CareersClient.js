...
import { ArrowRight, Briefcase, Clock, DollarSign, Mail, MapPin } from "lucide-react"
import Script from "next/script"
import { useEffect, useState } from "react"
import JupiNextLoader from "../../components/ui/JupiNextLoader"
        ...
        const fetchJobs = async () => {
            try {
                const res = await fetch(
                    `${process.env.NEXT_PUBLIC_API_URL}/jobs?active=true`,
                    { cache: 'no-store' }
                )
                    ...
                    <div className="mx-auto max-w-7xl">
                        ...
                        <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
                            <Card className="rounded-xl border border-border bg-card p-6 text-center">
                                ...
                                <h3 className="text-lg font-semibold text-primary">Remote Flexibility</h3>
                            ...
                            <Card className="rounded-xl border border-border bg-card p-6 text-center">
                                ...
                                <h3 className="text-lg font-semibold text-primary">Competitive Salary</h3>
                                <p className="mt-2 text-sm text-muted-foreground">
                            ...
                            <Card className="rounded-xl border border-border bg-card p-6 text-center">
                                ...
                                <h3 className="text-lg font-semibold text-primary">Learning Budget</h3>
                                <p className="mt-2 text-sm text-muted-foreground">
                            ...
                            <Card className="rounded-xl border border-border bg-card p-6 text-center">
                                ...
                                <h3 className="text-lg font-semibold text-primary">Great Team</h3>
                                <p className="mt-2 text-sm text-muted-foreground">
                                        ...
                                        >
                                            <div className="flex flex-col lg:flex-row gap-6">
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <div className="mt-4">
                                                        <h4 className="font-semibold text-accent">Requirements:</h4>
                                                ...
                                                <div className="flex flex-col justify-between lg:w-72 bg-gradient-to-br from-primary/5 to-transparent border border-primary/10 rounded-xl p-6 hover:border-primary/30 transition-all duration-300 hover:shadow-lg hover:shadow-primary/5">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="mt-6 text-sm text-muted-foreground space-y-2">
                                                            ...
                                                            <p>
                                                                <span className="font-semibold text-secondary">Location:</span> {job.location}
                                                            </p>
                                                        </div>
                                                    </div>
